...
{{--        <x-widgets.cemetery.about :target="$item"></x-widgets.cemetery.about>--}}
{{--        <x-widgets.cemetery.contributed :target="$item"></x-widgets.cemetery.contributed>--}}
{{--        <x-shared.content.ad></x-shared.content.ad>--}}
{{--        <x-widgets.cemetery.photos :target="$item"></x-widgets.cemetery.photos>--}}
{{--      </div>--}}
{{--      <div class="sticky sticky-top flex flex-col">--}}
{{--        <x-widgets.cemetery.menu :target="$item"></x-widgets.cemetery.menu>--}}

{{--        <div class="py-3">--}}
{{--          @unless($item->desription)--}}
{{--            <i class="text-gray-600 text-xs">This cemetery currently has no description.</i>--}}
{{--          @else--}}
{{--            {!! $item->description !!}--}}
{{--          @endif--}}
{{--        </div>--}}
...
{{--  <section class="border-t pt-10 pb-5">--}}
